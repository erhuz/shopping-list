                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <form onSubmit={handleSubmit} method="POST">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-1 rounded-md shadow-sm">
                                <input id="password_confirmation" type="password" required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" value={values.password_confirmation} onChange={handleChange} />
                            </div>
                        </div>
