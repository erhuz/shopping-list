...
export default function ListItem({ item, updateItem, deleteItem }) {
    ...
    return (
        <div className="flex justify-between">
            ...
            <span className="inline-flex rounded-md shadow-sm">
                <button onClick={() => {deleteItem(item)}} type="button" className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red active:bg-red-700 transition ease-in-out duration-150">
                    <svg className="h-5 w-5 group-hover:text-gray-500 group-focus:text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
